    ...
    public function search(Request $request){
        try
        {
            ...
            else
            {
                ...
                // // echo 'Search = '.$query; die();
                // // $allData = CompanyDetails::where('company_status', 'Active')->where('company_name', 'like', "%$query%")->get();
                // // return $allData;

                // // return view('allUsers.company-details', $data);
...
$queryCompanyDetails = $modelCompanyDetails
